...
namespace PA5_Draft
{
    ...
    class SnakeGame
    {
        ...
        public SnakeGame(System.Drawing.Point startingPoint, int Length, int AppleCount, Size GameFieldSize, int Obstacle)
        {
            ...
            if(Obstacle == 2)
            {
                ...
                Obstacles.Add(new LineSeg(new Point(GameFieldSize.Width - 1, GameFieldSize.Height - 1), new Point(GameFieldSize.Width - 1, 1)));
                Obstacles.Add(new LineSeg(new Point(1, 1), new Point(GameFieldSize.Width - 1, 1)));
                Obstacles.Add(new LineSeg(new Point(150, 300), new Point(450, 300)));
            }
            if(Obstacle == 3)
            {
                Obstacles = new List<LineSeg>();
            ...
            if(Obstacle == 5)
            {
                ...
                Obstacles.Add(new LineSeg(new Point(GameFieldSize.Width - 1, GameFieldSize.Height - 1), new Point(GameFieldSize.Width - 1, 1)));
                Obstacles.Add(new LineSeg(new Point(1, 1), new Point(GameFieldSize.Width - 1, 1)));
                Obstacles.Add(new LineSeg(new Point(150, 150), new Point(450, 450)));
                Obstacles.Add(new LineSeg(new Point(150, 450), new Point(450, 150)));
            }
            if(Obstacle == 6)
            {
                Obstacles = new List<LineSeg>();
                ...
                Obstacles.Add(new LineSeg(new Point(1, 1), new Point(GameFieldSize.Width - 1, 1)));
                Obstacles.Add(new LineSeg(new Point(150, 300), new Point(450, 300)));
                Obstacles.Add(new LineSeg(new Point(300, 150), new Point(300, 160)));
                Obstacles.Add(new LineSeg(new Point(300, 450), new Point(300, 460)));
                Obstacles.Add(new LineSeg(new Point(301, 150), new Point(301, 160)));
                Obstacles.Add(new LineSeg(new Point(301, 450), new Point(301, 460)));
                Obstacles.Add(new LineSeg(new Point(301, 150), new Point(302, 160)));
                Obstacles.Add(new LineSeg(new Point(301, 450), new Point(302, 460)));
            }
            if(Obstacle == 7)
            {
                Obstacles = new List<LineSeg>();
            ...
            if(Obstacle == 8)
            {
                ...
                Obstacles.Add(new LineSeg(new Point(GameFieldSize.Width - 1, GameFieldSize.Height - 1), new Point(GameFieldSize.Width - 1, 1)));
                Obstacles.Add(new LineSeg(new Point(1, 1), new Point(GameFieldSize.Width - 1, 1)));
                Obstacles.Add(new LineSeg(new Point(250, 150), new Point(350, 150)));
                Obstacles.Add(new LineSeg(new Point(150, 300), new Point(250, 150)));
                Obstacles.Add(new LineSeg(new Point(350, 150), new Point(450, 300)));
            }
            if(Obstacle == 9)
            {
                Obstacles = new List<LineSeg>();
                ...
                Obstacles.Add(new LineSeg(new Point(GameFieldSize.Width - 1, GameFieldSize.Height - 1), new Point(GameFieldSize.Width - 1, 1)));
                Obstacles.Add(new LineSeg(new Point(1, 1), new Point(GameFieldSize.Width - 1, 1)));
                Obstacles.Add(new LineSeg(new Point(200, 350), new Point(400, 350)));
                Obstacles.Add(new LineSeg(new Point(200, 350), new Point(200, 150)));
                Obstacles.Add(new LineSeg(new Point(400, 350), new Point(400, 150)));
            }
