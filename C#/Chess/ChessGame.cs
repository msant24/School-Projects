...
namespace PA6_Draft
{
    ...
    class ChessGame
    {
        ...
        internal event ChessEvent Start;
        internal event ChessEvent Stop;
        ...
        {
            get { return this.WhiteTimeLimit; }
            set { this.WhiteTimeLimit = value; }
        }
        internal string BlackTimeLimit;
        public string BlackTime
        {
            get { return this.BlackTimeLimit; }
            set { this.BlackTimeLimit = value; }
        }
        ...
        internal bool Move(Move move)//If the move is not legal, returns false, otherwise, it makes the move and returns true...
        {
            if (!LegalMove(move,false))
                return false;
            Start(move);
            System.Media.SoundPlayer player = new System.Media.SoundPlayer("D:/Shool Stuff/Fall 2020/COP 4226/PA6 Draft/PA6 Draft/53403__calaudio__wood-block.wav");
            player.Play();
            int x1 = move.X1, y1 = move.Y1, x2 = move.X2, y2 = move.Y2;
            move.MovedPiece = Board[x1][y1].Occupant;
            ...
            {
                System.Media.SoundPlayer player2 = new System.Media.SoundPlayer("D:/Shool Stuff/Fall 2020/COP 4226/PA6 Draft/PA6 Draft/546120__el-boss__piece-capture.wav");
                player2.Play();
            }
            if(WhiteTurn)
            ...
            if (move.Checkmate)
            {
                System.Media.SoundPlayer player4 = new System.Media.SoundPlayer("D:/Shool Stuff/Fall 2020/COP 4226/PA6 Draft/PA6 Draft/456966__funwithsound__success-fanfare-trumpets.wav");
                player4.Play();
                Stop(move);
            }
            if (move.Stalemate)
            {
                System.Media.SoundPlayer player5 = new System.Media.SoundPlayer("D:/Shool Stuff/Fall 2020/COP 4226/PA6 Draft/PA6 Draft/198874__bone666138__fanfare.wav");
                player5.Play();
                Stop(move);
            }
            ...
            if (move.Check)
            {
                System.Media.SoundPlayer player3 = new System.Media.SoundPlayer("D:/Shool Stuff/Fall 2020/COP 4226/PA6 Draft/PA6 Draft/335586__littlerainyseasons__warning.wav");
                player3.Play();
            }
            Moves.Add(move);
            WhiteTurn = !WhiteTurn;
