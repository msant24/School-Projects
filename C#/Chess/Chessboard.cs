...
namespace PA6_Draft
{
    public partial class Chessboard : Form
    {
        ...
        private object Game_Stop(Move move)
        {
            MainTimer.Stop();
            return 0;
        }

        private Object Game_Start(Move move)
        {
            MainTimer.Start();
            return 0;
        }
        ...
        private void MainTimer_Tick(object sender, EventArgs e)
        {
            if (Game.WhiteTurn)
            {
                ...
                else
                {
                    ...
                    if (Player1Time.Text.Equals("9.99"))
                    {
                        System.Media.SoundPlayer player = new System.Media.SoundPlayer("D:/Shool Stuff/Fall 2020/COP 4226/PA6 Draft/PA6 Draft/182351__kesu__alarm-clock-beep.wav");
                        player.Play();
                    }
                    Binding whitetime = new Binding("Text", Game, "WhiteTime", true);
                    Player1Time.DataBindings.Clear();
                    Player1Time.DataBindings.Add(whitetime);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (Player2Time.Text.Equals("9.99"))
                    {
                        System.Media.SoundPlayer player2 = new System.Media.SoundPlayer("D:/Shool Stuff/Fall 2020/COP 4226/PA6 Draft/PA6 Draft/182351__kesu__alarm-clock-beep.wav");
                        player2.Play();
                    }
                    Binding blacktime = new Binding("Text", Game, "BlackTime", true);
                    Player2Time.DataBindings.Clear();
                    Player2Time.DataBindings.Add(blacktime);
                }
            }
        }
